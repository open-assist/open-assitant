...
export type VectorStoreFileObject = {
   ...
   */
  chunking_strategy: OtherChunkingStrategy | StaticChunkingStrategy;
  /**
   * FileId in request is url, when type is url. The default is file.
   *
   * @default 'file'
   */
  type?: "file" | "url";
  /**
   * Read content from the url, when type is url.
   */
  url?: string;
} & ObjectMeta;
...
export type CreateVectorStoreRequest = {
   ...
   */
  chunking_strategy?: AutoChunkingStrategy | StaticChunkingStrategy | null;
