...
export type AutoChunkingStrategy = z.infer<typeof AutoChunkingStrategy>;
export const AutoChunkingStrategy = z.object({
  type: z.literal("auto"),
});

export type OtherChunkingStrategy = z.infer<typeof OtherChunkingStrategy>;
export const OtherChunkingStrategy = z.object({
  type: z.literal("other"),
});

export type StaticChunkingStrategy = z.infer<typeof StaticChunkingStrategy>;
export const StaticChunkingStrategy = z.object({
  type: z.literal("static").default("static"),
  static: z.object({
    max_chunk_size_tokens: z.number().min(100).max(4096).default(800),
    chunk_overlap_tokens: z.number().default(400),
  }),
});
...
export const VectorStoreFileObject = z.intersection(
  z.object({
    ...
    chunking_strategy: z.union([OtherChunkingStrategy, StaticChunkingStrategy]),
    type: z
      .union([z.literal("file"), z.literal("url")])
      .default("file")
      .optional(),
...
export const CreateVectorStoreRequest = z.object({
  ...
  expires_after: z
    ...
    .nullish(),
  chunking_strategy: z
    .union([AutoChunkingStrategy, StaticChunkingStrategy, z.null()])
    .optional(),
  metadata: Metadata.nullish(),
});
